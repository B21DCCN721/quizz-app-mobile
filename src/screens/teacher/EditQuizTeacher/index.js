...
const EditQuizScreenTeacher = ({ route }) => {
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await axiosClient.put('/api/teacher/exercises/update/multiple-choice/' + id, payload);
...
export default EditQuizScreenTeacher;
